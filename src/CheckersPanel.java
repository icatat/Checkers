        ...
        if (state != null) {
            ...
            for (row = 0; row <= 7; row++) {
                for (col = 0; col <= 7; col++) {
                    ...
                    State.Player owner = state.getPieceOwner(row, col);
                    ...
                    } else if (owner == State.Player.PLAYER2) {
        	...
        	//TODO Human Player check at end
//        if (isHumansTurn()) {
//            /*
...
//        }
        ...
        for (col = 0; col <= 7; col++) {
            String legend = Piece.colnames[col];
            int tWidth = g.getFontMetrics().stringWidth(legend) + 4;
            int tHeight = g.getFontMetrics().getHeight() + 4;
...
//        }
    ...
    private Piece mouseCoordsToRowCol(MouseEvent e) {
//        int x = e.getX();
//        int y = e.getY();
//        int height = getHeight();
//        int width = getWidth();
